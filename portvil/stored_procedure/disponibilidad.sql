...
BEGIN
    ...
    WHILE (i <= contador_date_uno) DO
     ...
     # Insert query;
     INSERT INTO hshv_avantio_availabilities (`accommodation_id`, `occupation_rule_id` , `fecha`, `status` , `update_at`) VALUES (282 , 282 , @stat_date , 0 , CURDATE());
     SET i = i + 1;
